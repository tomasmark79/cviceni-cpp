...
void fce1()
{
    cout << "ukonèovací práce: fce1" << endl;
}
void fce2()
{
    cout << "ukonèovací práce: fce2" << endl;
}
...
int main(int argc, char *argv[], char* env[])
{
    ...
    vstup_mam_pokracovat("Chcete pokraèovat?");
    ...
    // provedou se ukonèovací práce pomocí zaregistrování funkce
    atexit(fce1);
    atexit(fce2);

    cout << "Parametry pøíkazové øádky programu pøi spuštìní: " << endl;
    ...
    //
    // PØÍKLAD 14.3: VÝPIS VŠECH PROMÌNNÝCH PROSTØEDÍ
    //
    cout << "Aktuální systémové promìnné: " << endl;
    for(int i{0}; env[i]; i++)
    {
        // poslední prvek pole env obsahuje nullptr
        cout << env[i] << endl;
    }

    //
    // PØÍKLAD 14.2: OBSAH SYSTÉMOVÉ PROMÌNNÉ PATH
    //
    // Vypíše promìnné operaèního systému
    // Nullptr = pokud neexistuje promìnná
    cout << "Promìnná PATH: " << endl << getenv("PATH") << endl;
